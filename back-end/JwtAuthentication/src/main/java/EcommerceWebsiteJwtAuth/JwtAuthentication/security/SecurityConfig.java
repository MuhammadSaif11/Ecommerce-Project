package EcommerceWebsiteJwtAuth.JwtAuthentication.security;

import EcommerceWebsiteJwtAuth.JwtAuthentication.service.UserServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(req -> req
                        .requestMatchers("/registerUser","/login","/forgot-password","verify-otp").permitAll()
